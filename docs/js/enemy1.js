 ...
 */
var Enemy1 = function (_Character) {
  _inherits(Enemy1, _Character);

  function Enemy1(speed, row, player) {
    _classCallCheck(this, Enemy1);

    var _this = _possibleConstructorReturn(this, (Enemy1.__proto__ || Object.getPrototypeOf(Enemy1)).call(this, 0, 83 * row + 10));

    _this.sprite = 'images/enemy2.png';
    _this.player = player;
    _this.speed = speed;
    return _this;
  }
